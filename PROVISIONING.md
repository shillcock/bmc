# How to provision a new environment for bmc

This project uses the open source [capistrano-fiftyfive](https://github.com/mattbrictson/capistrano-fiftyfive) set of tasks for capistrano to provision new environments. This document contains a quick overview of the provisioning process.
