...
sudo service unicorn_bmc <start|stop|restart>
sudo service sidekiq_bmc <start|stop>
```
...
```
/home/deployer/apps/bmc/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_bmc restart
sudo service sidekiq_bmc stop
sudo service sidekiq_bmc start
```
